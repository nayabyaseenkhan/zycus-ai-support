...
def main():
    ...
    # Test missing ticket
    missing_ticket = get_ticket("INVALID_TICKET_ID")
    ...
    missing_account = get_account("INVALID_ACCOUNT_ID")
    ...
    # Test recent tickets
    recent_tickets = get_recent_tickets(account_id, days=90)

    print(f" get_recent_tickets() passed")
    print(f"  Recent tickets found: {len(recent_tickets)}")
